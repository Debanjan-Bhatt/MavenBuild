node(){
	...
	stage('Code Checkout'){
		checkout changelog: false, poll: false, scm: scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'Debanjandevopslearn', url: 'https://github.com/Debanjan-Bhatt/MavenBuild']])
	}
